...
#define STRING_CONFIG_H_AUTHOR "Marco (Kedyn) Paglioni" // Who made the changes. //###Kedryn###
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V2_0_REV_B //###Kedryn### ###SKR2###
#endif
 ...
 */
#define SERIAL_PORT 1 //###Kedryn### ###SKR2###
 ...
 */
#define BAUDRATE 112500 //###Kedryn### ###King's###

#define BAUD_RATE_GCODE     // Enable G-code M575 to set the baud rate //###Kedryn### ###SKR2###
 ...
 */
#define SERIAL_PORT_2 -1 //###Kedryn### ###SKR2###
#define BAUDRATE_2 112500   // :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE //###Kedryn### ###King's###
...
#define CUSTOM_MACHINE_NAME "Kedryn's Sunlu S8" //###KEDRYN###
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //###Kedryn### ###SKR2###
#define Y_DRIVER_TYPE  TMC2209 //###Kedryn### ###SKR2###
#define Z_DRIVER_TYPE  TMC2209 //###Kedryn### ###SKR2###
//#define X2_DRIVER_TYPE A4988
//#define Y2_DRIVER_TYPE A4988
#define Z2_DRIVER_TYPE TMC2209 //###Kedryn### ###SKR2###
...
#define E0_DRIVER_TYPE TMC2209 //###Kedryn### ###SKR2###
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.20 //###King's###
    #define DEFAULT_Ki   2.42 //###King's###
    #define DEFAULT_Kd  60.50 //###King's### 
  #endif
#else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 177.20 //###Kedryn### ###King's###
  #define DEFAULT_bedKi 025.23 //###Kedryn### ###King's###
  #define DEFAULT_bedKd 829.40 //###Kedryn### ###King's###
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW //###Kedryn### ###SKR2###
#define X_MAX_ENDSTOP_HIT_STATE LOW //###Kedryn### ###SKR2###
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 640, 640, 3200, 854 } //###Kedryn###
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 450, 450, 12, 100 } //###Kedryn### ###King's###
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 750, 750, 100, 5000 } //###Kedryn### ###King's###
 ...
 */
#define DEFAULT_ACCELERATION          600    // X, Y, Z and E acceleration for printing moves //###Kedryn### ###King's###
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   750    // X, Y, Z acceleration for travel (non printing) moves //###Kedryn### ###King's###
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0012 // (mm) Distance from real junction edge //###Kedryn### ###King's###
 ...
 */
#define S_CURVE_ACCELERATION //###Kedryn### ###King's###
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //###Kedryn### ###BLTOUCH###

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING //###Kedryn### ###BLTOUCH###
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {30, 0, -1.675} //###Kedryn###
...
#define PROBING_MARGIN 25 //###King's###

// X and Y axis travel speed between probes.
// Leave undefined to use the average of the current XY homing feedrate.
#define XY_PROBE_FEEDRATE (120*60) //###Kedryn### ###King's###

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (6*60) //###Kedryn###  ###King's###

// Feedrate for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 3) //###Kedryn### ###King's###
 ...
 */
#define MULTIPLE_PROBING 2 //###Kedryn### ###King's###
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    5 // (mm) Z Clearance for Deploy/Stow //###Kedryn###
#define Z_CLEARANCE_BETWEEN_PROBES  3 // (mm) Z Clearance between probe points //###Kedryn###
#define Z_CLEARANCE_MULTI_PROBE     3 // (mm) Z Clearance between multiple probes //###Kedryn###
...
#define INVERT_X_DIR false //###Kedryn### ###SKR2###
#define INVERT_Y_DIR false //###Kedryn### ###SKR2###
#define INVERT_Z_DIR true //###Kedryn### ###SKR2###
...
#define INVERT_E0_DIR false //###Kedryn### ###SKR2###
...
#define X_BED_SIZE 310  //###Kedryn### ###King's###
#define Y_BED_SIZE 310  //###Kedryn### ###King's###

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -4.5 ///###Kedryn### ###King's###
#define Y_MIN_POS -1.5 //###Kedryn### ###King's###
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 410 //###Kedryn### ###King's###
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define FILAMENT_RUNOUT_SENSOR //###Kedryn### ###SKR2###
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
  #define FIL_RUNOUT_PIN PC2              //###Kedryn### ###SKR2###
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25 //###Kedryn### ###King's###
...
#define AUTO_BED_LEVELING_BILINEAR  //###Kedryn### ###King's###
 ...
 */
//#define RESTORE_LEVELING_AFTER_G28 //###Kedryn### ###King's###
#define ENABLE_LEVELING_AFTER_G28 //###Kedryn### ###King's###
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set a height for the start of manual adjustment
    #define MANUAL_PROBE_START_Z 0.5  // (mm) Comment out to use the last-measured height //###Kedryn### ###King's###
#endif
   ...
   */
    #define G26_MESH_VALIDATION //###Kedryn###
  ...
  #define GRID_MAX_POINTS_X 5  //###Kedryn###
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID  //###Kedryn###

    //
    // Subdivision of the grid by Catmull-Rom method.
    // Synthesizes intermediate points to produce a more detailed mesh.
    //
    #define ABL_BILINEAR_SUBDIVISION  //###Kedryn###
  ...
  #define MESH_INSET 25          // Set Mesh bounds as an inset region of the bed //###Kedryn### ###King's###
  #define GRID_MAX_POINTS_X 5    // Don't use more than 7 points per axis, implementation limited. //###Kedryn###
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
//#define LCD_BED_LEVELING
  ...
  #define LCD_PROBE_Z_RANGE 2     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment //###Kedryn### ###King's###
  #define MESH_EDIT_MENU        // Add a menu to edit mesh points ///###Kedryn###
#endif

// Add a menu item to move between bed corners for manual bed adjustment
#define LCD_BED_TRAMMING //###Kedryn###
...
#define HOMING_FEEDRATE_MM_M { (80*60), (80*60), (6*60) } //###Kedryn### ###King's###
...
//#define SKEW_CORRECTION
  ...
  #define XY_SKEW_FACTOR 0.0 //###Kedryn### ###King's###
  ...
  //#define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_SKEW_FACTOR 0.0 //###Kedryn### ###King's###
    #define YZ_SKEW_FACTOR 0.0 //###Kedryn### ###King's###
  #endif
...
#define PREHEAT_1_TEMP_BED     60 //###Kedryn###
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG" //###Kedryn###
#define PREHEAT_2_TEMP_HOTEND 230 //###Kedryn###
#define PREHEAT_2_TEMP_BED    70 //###Kedryn###
#define PREHEAT_2_TEMP_CHAMBER 35 //###Kedryn###
#define PREHEAT_2_FAN_SPEED     0 // Value from 0 to 255 //###Kedryn###
 ...
 */
#define NOZZLE_PARK_FEATURE //###Kedryn###
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN //###Kedryn### ###King's###
 ...
 */
//#define NO_LCD_MENUS
#define SLIM_LCD_MENUS //###Kedryn### ###SKR2###
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //###Kedryn###
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 //###Kedryn### ###King's###
#define LCD_FEEDBACK_FREQUENCY_HZ 10000 //###Kedryn### ###King's###
...
//
#define CR10_STOCKDISPLAY //###Kedryn###
