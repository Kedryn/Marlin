...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_GT2560_REV_A_PLUS //###Kedryn###
#endif
...
//#define CUSTOM_MACHINE_NAME "i3 Pro B" //###Kedryn###
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  12.33,  12.33 } //###Kedryn###
    #define DEFAULT_Ki_LIST {   0.51,   0.51 } //###Kedryn###
    #define DEFAULT_Kd_LIST {  74.50,  74.50 } //###Kedryn###
  #else
    // Geeetech MK8 Extruder //###Kedryn###
    #define DEFAULT_Kp  12.33
    #define DEFAULT_Ki   0.51 //###Kedryn###
    #define DEFAULT_Kd  74.50 //###Kedryn###
  #endif
#else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 234.88 //###Kedryn###
  #define DEFAULT_bedKi 42.79 //###Kedryn###
  #define DEFAULT_bedKd 322.28 //###Kedryn###
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.34, 80.22, 401.4, 100 } //###Kedryn###
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 2, 45 } //###Kedryn###
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 10000 } //###Kedryn###
 ...
 */
#define DEFAULT_ACCELERATION          1000    // X, Y, Z and E acceleration for printing moves  //###Kedryn###
#define DEFAULT_RETRACT_ACCELERATION  2000    // E acceleration for retracts  //###Kedryn###
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.004 // (mm) Distance from real junction edge  //###Kedryn###
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  //###Kedryn###
...
#define Z_MIN_PROBE_PIN 11 //###Kedryn###
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, -27, -2.25 } //###Kedryn###
...
#define Z_PROBE_FEEDRATE_FAST (20*60)  //###Kedryn###
 ...
 */
#define MULTIPLE_PROBING 2 //###Kedryn###
...
#define Z_MIN_PROBE_REPEATABILITY_TEST //###Kedryn###
 ...
 */
//#define PROBING_HEATERS_OFF       // Turn heaters off when probing //###Kedryn###
#if ENABLED(PROBING_HEATERS_OFF)
  //#define WAIT_FOR_BED_HEATER     // Wait for bed to heat back up between probes (to improve accuracy)
  //#define WAIT_FOR_HOTEND         // Wait for hotend to heat back up between probes (to improve accuracy & prevent cold extrude)
#endif
#define PROBING_FANS_OFF          // Turn fans off when probing //###Kedryn###
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
#define DELAY_BEFORE_PROBING 200  // (ms) To prevent vibrations from triggering piezo sensors //###Kedryn###
...
//#define DISABLE_X //###Kedryn###
//#define DISABLE_Y //###Kedryn###
//#define DISABLE_Z //###Kedryn###
//#define DISABLE_I
//#define DISABLE_J
//#define DISABLE_K
//#define DISABLE_U
...
#define INVERT_X_DIR true //###Kedryn###
...
#define INVERT_E0_DIR true //###Kedryn###
#define INVERT_E1_DIR true //###Kedryn###
#define INVERT_E2_DIR true //###Kedryn###
#define INVERT_E3_DIR true //###Kedryn###
#define INVERT_E4_DIR true //###Kedryn###
#define INVERT_E5_DIR true //###Kedryn###
#define INVERT_E6_DIR true //###Kedryn###
#define INVERT_E7_DIR true //###Kedryn###
...
#define X_MIN_POS -12  //###Kedryn###
#define Y_MIN_POS -8  //###Kedryn###
#define Z_MIN_POS 0
#define X_MAX_POS (-X_MIN_POS+X_BED_SIZE) //###Kedryn###
#define Y_MAX_POS (-Y_MIN_POS+Y_BED_SIZE) //###Kedryn###
...
#define AUTO_BED_LEVELING_BILINEAR //###Kedryn###
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 4 //###Kedryn###
 ...
 */
#define SKEW_CORRECTION //###Kedryn###

#if ENABLED(SKEW_CORRECTION)
  // Input all length measurements here:
  #define XY_DIAG_AC 282.8427124746
  #define XY_DIAG_BD 281.8196945719 //###Kedryn###
  ...
  #define SKEW_CORRECTION_GCODE //###Kedryn###
#endif
...
#define PREHEAT_1_TEMP_HOTEND 200 //###Kedryn###
...
#define PREHEAT_2_TEMP_BED    90 //###Kedryn###
 ...
 */
#define SD_CHECK_AND_RETRY //###Kedryn###
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 //###Kedryn###
#define LCD_FEEDBACK_FREQUENCY_HZ 5000 //###Kedryn###
...
//
#define REPRAP_DISCOUNT_SMART_CONTROLLER //###Kedryn###
