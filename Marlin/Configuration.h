...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V1_2 //###Kedryn###
  #define NO_CONTROLLER_CUSTOM_WIRING_WARNING //###Kedryn###														
#endif
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //###Kedryn###
#define Y_DRIVER_TYPE  TMC2209 //###Kedryn###
#define Z_DRIVER_TYPE  TMC2209 //###Kedryn###
...
#define E0_DRIVER_TYPE TMC2209 //###Kedryn###
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.73,  21.73 } //###Kedryn###
    #define DEFAULT_Ki_LIST {   1.54,   1.54 } //###Kedryn###
    #define DEFAULT_Kd_LIST {  76.55,  76.55 } //###Kedryn###
  #else
    #define DEFAULT_Kp  21.73 //###Kedryn###
    #define DEFAULT_Ki   1.54 //###Kedryn###
    #define DEFAULT_Kd  76.55 //###Kedryn###
  #endif
#else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 50.71  //###Kedryn###
  #define DEFAULT_bedKi 9.88   //###Kedryn###
  #define DEFAULT_bedKd 173.43 //###Kedryn###
...
#define EXTRUDE_MINTEMP 180 //###Kedryn###
...
#define EXTRUDE_MAXLENGTH 600 //###Kedryn### 
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 } //###Kedryn###
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } //###Kedryn###
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 5000 } //###Kedryn###
 ...
 */
#define DEFAULT_ACCELERATION           500    // X, Y, Z and E acceleration for printing moves //###Kedryn###
#define DEFAULT_RETRACT_ACCELERATION   500    // E acceleration for retracts //###Kedryn###
#define DEFAULT_TRAVEL_ACCELERATION    500    // X, Y, Z acceleration for travel (non printing) moves //###Kedryn###
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.008 // (mm) Distance from real junction edge //###Kedryn###
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -49, -10, -1.03 } //###Kedryn###
...
#define XY_PROBE_FEEDRATE (133*60) //###Kedryn###

// Feedrate for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (4*60) //###Kedryn###
...
#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing //###Kedryn###
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
//#define DELAY_BEFORE_PROBING 200  // (ms) To prevent vibrations from triggering piezo sensors

// Require minimum nozzle and/or bed temperature for probing
#define PREHEAT_BEFORE_PROBING //###Kedryn###
...
#define X_BED_SIZE 235 //###Kedryn###
#define Y_BED_SIZE 235 //###Kedryn###
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 //###Kedryn###
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
//#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash. //###Kedryn###
...
#define PREHEAT_1_TEMP_HOTEND 190 //###Kedryn###
#define PREHEAT_1_TEMP_BED     45 //###Kedryn###
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED   255 // Value from 0 to 255 //###Kedryn###
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN //##Kedryn
